...
(function() {
    ...
    function Sigma(root, id) {
        ...
        this.mousecaptor.bind('drag interpolate', function(e) {
            ...
            if (targeted.length) {       
                if(e.type=="mousedown"){                        
                    //pr("\n\tINSIDE TARGETED.LENGTH");
                    //pr("\t"+Nodes[targeted].label);
                    //pr("\t"+mousedownType);
                    //pr("");
                    if(mousedownType=="right"){
                        //do something with the right click
                        pr("\t\tdo something with the rightclick");
                    }
                }
                self.dispatch(
                ...
                if(cursor_size>0 && e.type=="mousedown"/* && mapDrag==false*/) {/**/
                    //Event: The click was not in a node when the cursor_size is ON
                    pr("Event: The click was not in a node when the cursor_size is ON");
...
//                    );
         ...
         * @return {Sigma} Returns itself.
         */
        function draw(nodes, edges, labels, safe) {/*regarde*/
    ...
    function MouseCaptor(dom) {
        ...
        function downHandler(event) {
            if (self.p.mouseEnabled) {
                mousedownType = (event.button==0)?"left":"right";
