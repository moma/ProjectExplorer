...
$sql = "SELECT * FROM scholars where css_voter='Yes' ORDER BY last_name";
...
<h2><a href="http://cssociety.org"><img src="http://www.complexssociety.eu/images/css1_small_80x2.png" align="center"></a>Voting Members of the Complex Systems Society</h2>
<br/><br/>
<br/>
<br/>
<p>
This directory presents the voting members of the <a href="http://cssociety.org" target="blank">Complex Systems
Society</a> (CSS): <a href="#scholars">'.  count($scholars).' scholars</a> belonging to <a href="#labs">'
