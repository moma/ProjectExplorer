...
$sql = "SELECT * FROM scholars where tags LIKE '%#unitwin%' ORDER BY last_name";
...
<a href="http://unitwin-cs.org/"><img src="custom/unitwin.jpg" align="center"></a>
<br/><br/>
<br/>
<br/>
<p>
This directory presents the members of the network of
the <a href="http://unitwin-cs.org/" target="blank">the Complex Systems Digital Campus is a UNESCO UniTwin,
a network of research and/or teaching institutions,
including universities, research organisms and industrial laboratories</a> : <a href="#scholars">'.  count($scholars).' scholars</a> belonging to <a href="#labs">'
