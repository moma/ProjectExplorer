...
$sql = "SELECT * FROM scholars where tags LIKE '%#iscn%' ORDER BY last_name";
...
<a href="http://iscn.univ-lehavre.fr"><img src="custom/iscn.png" align="center"></a>
<br/><br/>
<br/>
<br/>
<p>
This directory presents the members of the network of
the <a href="http://iscn.univ-lehavre.fr/" target="blank">Institut des Systèmes Complexes en Normandie</a> (ISCN): <a href="#scholars">'.  count($scholars).' scholars</a> belonging to <a href="#labs">'
.  count($labs).' labs</a> and <a href="#orga">'.$orga_count.' organizations</a> working in
the field of Complex Systems.';
$header .='
    
<ul>
<li><b><i>This directory is open to all scholars working in the field of complex systems in Normandie</i></b>. Anybody can have her profile included
...
<li><strong>Your are not in this directory ?</strong> Add the community tag #iscn in your <a href="http://main.csregistry.org/Whoswhodata" target="blank">complex systems profile</a>.
</ul> 
</p>
