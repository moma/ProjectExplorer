...
function getTips(){    
    ...
    text = '<div><h1>Semantic Landscape of the Rockefeller Projects Portfolio</h1><div><p>These maps display the different topics addressed in the selected Rockefeller Initiatives. Nodes in the graph correspond to relevant terms which have been extracted from the proposal with text-mining methods. <br/>Nodes are linked when some proposals make a strong relation between the corresponding terms.<br/><br/>Terms are clustered into large topics indicated by colors to help in browsing the graph.<br/><br/>When you clic on a set of nodes, additionnal information on your selection is display on the left panel like,  for example, the most related documents<br/></p><br/><br/><h4>TIPS</h4><p> <b>- You can search for an expression in the search bar.</b><br/> <b>- When a node is selected, you can clic in the side bar on its name to launch a google search on that term.</b><br/><br/><b>- Double clic an empty area to erase current selection</b></p></div><br/><center><strong>'+param+'</strong></center><br/><div id="footer"><p><i>Credits:</i> <a href="http://chavalarias.com" target="_blank" title="David Chavalarias"><img src="rock/user.png" width=15></a> </p></div></div>';
    return text;
}
