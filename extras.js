...
function getTips(){
    ...
    text =  param='href="#" onclick="selectionToMap();" ';
    text = '<div><h1>Semantic Landscapes of the Rockefeller Projects Portfolio</h1><div><p>This map displays the different topics addressed in the batch of projects indicated in the top bar. You can chose an other batch of projects with the drop down selector in the same bar. <br/>Nodes in the graph correspond to salient terms which have been extracted from the proposal with text-mining methods. Nodes are linked when some proposals make a strong relation between the corresponding terms.<br/><br/>Terms are clustered into large topics indicated by the colors to help browsing the map.<br/><br/>When you clic on a node, the set of projects that are the most strongly linked to your selection are displayed in the left column. You can visualize the geographical distribution of these projets by clicking on the earth picture.<br/></p><br/><br/><h4>TIPS</h4><p> <b>- You can search for an expression in the search bar.</b><br/><p> <b>- When a node is selected, you can clic in the side bar on its name to launch a google search on that term.</b><br/><p> <b>- Double clic on a node to get more information</b><br/><b>- Double clic an empty area to erase current selection</b></p></div><br/><center><strong><a '+param+' >See the network world distribution</a></strong></center><br/><div id="footer"><p><i>Credits:</i> <a href="http://chavalarias.com" target="_blank"><img src="rock/user.png" width=15></a> </p></div></div>';
    return text;
}
